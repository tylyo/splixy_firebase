...
function calculate(currTrx) {
  ...
  if (trxType == 'item') {
    ...
    if (quotaAmount !== round3Dec(currTrx.q.a)) console.warn(trxId, "QUOTA DIVERSA QUELLA REGISTRATA", currTrx.qt, paid, parts, quotaAmount, currTrx.q.a);
    for (const key in currTrx.debs) {
